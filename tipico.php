            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="full heading_s1">
                     <h2>Merengue Tipico</h2>
                  </div>
                  <div class="full">
                     <p class="large">El merengue típico es un género musical de la República Dominicana y el estilo más antiguo de merengue. Merengue típico es el término preferido por la mayoría de los músicos ya que es más respetuoso y enfatiza el carácter tradicional de la música.</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section class="layout_padding padding_bottom_0" style="background: #fff;">
         <div class="container">
            ...
            <?php
                    ...
                    if($conn){
                        $SELECT = "SELECT * FROM exponentes WHERE genero='Merengue Tipico' ORDER BY id_exponentes DESC LIMIT 3";
